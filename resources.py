...
text={
	...
	'services':{
		...
		'service_4': 'Creativity',
		'purpose': 'My Motto: ',
		'content': 'The importance of luck to our success diminishes as time goes longer.  It is a simple probability problem!'
	},
	'expertise':{
		'exp_1': {
			'name': 'Leadership',
		...
		'exp_3': {
			...
			'content': 'New problems come up everyday, The harder the problem, the more the pleasure'
		},
		'exp_4': {
			'name': 'Algorithm',
			'content': 'Generating efficient and high quality algorithm to support business needs'
		},
		'exp_5': {
			'name': 'Innovation',
		...
		'exp_6': {
			...
			'content': 'Following agile principles daily to develop reliable and useful products in shortest time possbile'
		}
